...
namespace TextBasedVentures
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new QuitCommand(), new SayCommand(), new StartCommand(),new NameCommand(), new BackCommand(), new OpenCommand(), new PickupCommand(), new InventoryCommand(), new DropCommand(), new QuestCommand() };
